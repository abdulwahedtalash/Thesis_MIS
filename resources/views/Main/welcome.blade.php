<html>
  <head>
    ...
    <link href="{{ asset('fontend/welcome/css/Result_button.css') }}" rel="stylesheet" />
  </head>
  <body>
          ...
          <div class="advance-search">
              ...
              <div class="input-field">
                <div class="input-select">
                  <select data-trigger="" name="choices-single-defaul">
                    <option placeholder="" value="">Supervisor</option>
            ...
            <div class="row second">
              ...
              <div class="input-field">
                <div class="input-select">
                  <select data-trigger="" name="choices-single-defaul">
                    <option placeholder="" value="">Project Type</option>
                    <option>Researh</option>
                    <option>MIS</option>
              ...
              <div class="input-field">
                <div class="input-select">
                  <select data-trigger="" name="choices-single-defaul">
                    <option placeholder="" value="">New Ideas</option>
                    <option>Subject b</option>
                    <option>Subject c</option>
                  </select>
                </div>
