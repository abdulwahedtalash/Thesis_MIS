...
<body>
	...
	<div class="inputGroup inputGroup1">
		...
		<input type="text" id="email" name="email" class="email"  maxlength="256" :value="old('email')" required autofocus autocomplete="username"/>
		
		<span class="indicator"></span>
	</div>
	<div class="inputGroup inputGroup2">
		<label for="password">Password</label>
		<input type="password" id="password" name="password" class="password" required autocomplete="current-password" />
	</div>
